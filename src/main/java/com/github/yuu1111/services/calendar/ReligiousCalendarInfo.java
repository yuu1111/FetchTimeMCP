...
public class ReligiousCalendarInfo {
  ...
  public String toString() {
    return "ReligiousCalendarInfo{" + "calendarType='" + calendarType + '\'' + ", date="
        + formatDate() + ", weekDay='" + weekDay + '\'' + ", leapYear=" + leapYear + ", holidays="
        + holidays.size() + ", observances=" + observances.size() + '}';
  }
}