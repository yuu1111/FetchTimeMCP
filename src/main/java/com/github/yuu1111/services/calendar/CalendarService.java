...
public class CalendarService {
    ...
    private boolean isLeapYear(Calendar calendar) {
        if (calendar instanceof ChineseCalendar) {
            ChineseCalendar chinese = (ChineseCalendar) calendar;
            return chinese.getActualMaximum(Calendar.MONTH) > 11;
        }
        if (calendar instanceof HebrewCalendar) {
            HebrewCalendar hebrew = (HebrewCalendar) calendar;
     ...
     * 祝日と記念日を設定
     */
    private void setHolidaysAndObservances(ReligiousCalendarInfo info, 
                                          Calendar calendar, CalendarType type) {
     ...
     * イスラム暦の祝日設定
     */
    private void setIslamicHolidays(Map<String, String> holidays, 
                                   Map<String, String> observances,
                                   Calendar calendar) {
        int month = calendar.get(Calendar.MONTH);
     ...
     * ヘブライ暦の祝日設定
     */
    private void setHebrewHolidays(Map<String, String> holidays,
                                  Map<String, String> observances,
                                  Calendar calendar) {
        int month = calendar.get(Calendar.MONTH);
        int day = calendar.get(Calendar.DAY_OF_MONTH);
     ...
     * 仏教暦の祝日設定
     */
    private void setBuddhistHolidays(Map<String, String> holidays,
                                    Map<String, String> observances,
                                    Calendar calendar) {
        // 簡易的な実装
        int month = calendar.get(Calendar.MONTH);
     ...
     * 中国暦の祝日設定
     */
    private void setChineseHolidays(Map<String, String> holidays,
                                   Map<String, String> observances,
                                   Calendar calendar) {
        if (calendar instanceof ChineseCalendar) {
            int month = calendar.get(Calendar.MONTH);
     ...
     * 日本暦の祝日設定
     */
    private void setJapaneseHolidays(Map<String, String> holidays,
                                    Map<String, String> observances,
                                    Calendar calendar) {
